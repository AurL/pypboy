...
class Module(pypboy.SubModule):
	...
	def __init__(self, *args, **kwargs):
		...
		self.menu = pypboy.ui.SelectableMenu(200, [p[0] for p in config.APPAREL], [], self.update_content, 0, True)
		self.menu.rect[0] = 15
		self.menu.rect[1] = 40
		self.add(self.menu)
		self.item_view = pypboy.ui.Itemview(config.APPAREL, 'art\\apparel\\', True)
